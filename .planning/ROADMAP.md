...
| 13. Image Generation | v1.3 | 0/2 | Pending | |
...
Plans:
- [ ] 13-01-PLAN.md — Fix client proxy option forwarding (999.5)
- [ ] 13-02-PLAN.md — Fix edge function + providers + config optimization (999.5, 999.6, 999.7)
