# Requirements Archive: v1.0 Hardening & Praticar Redesign
...
- [x] **PERF-01**: User only downloads the code for the page they're viewing (lazy-loaded route components)
- [x] **PERF-02**: User sees a loading indicator while a page chunk is being fetched (loading states)
- [x] **PERF-03**: User's initial bundle excludes heavy dependencies like jspdf and motion (separate chunks)
...
- [x] **SEC-04**: User's API keys are not sent directly to AI providers from the browser (server-side Edge Function proxy)
...
*Last updated: 2026-04-02 before v1.0 milestone completion*
