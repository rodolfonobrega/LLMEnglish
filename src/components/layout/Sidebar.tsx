...
import { Compass, RotateCcw, Mic, BookOpen, Settings, AlertTriangle, Flame, LifeBuoy } from 'lucide-react';
            ...
            {stats && stats.streak > 0 && (
                <div className="p-4 border-t border-border">
                    <div className="bg-gradient-to-br from-orange-400 to-orange-500 rounded-2xl p-4 text-white">
                        ...
                        <p className="text-sm text-orange-100">Keep it up! You're doing great!</p>
                    </div>
                </div>
            )}
        </aside>
